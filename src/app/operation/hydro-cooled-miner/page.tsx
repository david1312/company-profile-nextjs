...
import styles from "./hydro-cooled-miner.module.css";

const HydroCooledMiner: React.FC = () => {
  return (
    <div className="flex flex-col first-section">
      ...
      <div className="bg-b-third p-2 sm:p-4 md:p-4 lg:p-4 xl:p-4">
        <div className="text-center b-section-title text-white pt-6">
          <p className="max-w-xl ">Hydro Cooled Miner</p>
        </div>
        {LIST_PROJECT.filter(
          (val) => val.type === MINING_TYPE.HYDRO_COOLED
        ).map((val, i) => {
          return (
            <div
              className="flex justify-center p-2 sm:p-4 md:p-4 lg:p-4 xl:p-4"
...
export default HydroCooledMiner;
