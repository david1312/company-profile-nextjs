...
import { PartnershipWrapper } from "./partnership.styles";
                ...
                <div className="col-span-8 sm:col-span-4 ">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="col-span-2 text-lg">
                      ...
                      and distributors of ASIC miners and equipment solutions,
                      and the influencers, tutors or other Bitcoin/crypto
                      educators. Through this partnership, we hope to provide
                      each other with optimal benefits and support mutual growth
